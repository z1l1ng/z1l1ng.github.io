...
- Lines: Sharp lines for cleaniness look again, everything is formatted nicely.

- Shapes: A rectangle is used with text inside as, this also adds to the sharp lines. 
...
- Lines: Are not all sharp anymore, we have curves now separating the name and nutrition label with an image and facts about the product. 
