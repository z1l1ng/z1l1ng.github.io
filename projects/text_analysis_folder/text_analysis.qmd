...
big_data |>
  ...
  count(country) |>
  slice_max(n, n = 10) |>
  ggplot(aes(y = fct_reorder(country, n), x = n, fill = service)) +
    geom_bar(stat = "identity", show.legend = FALSE) +
    facet_wrap(~ service, scales = "free") +
  labs(
...
A word cloud of the top 75 words associated with pink (joy) and top 75 words associated with sadness (blue). Are there more words associated with joy or with sadness in our titles?
...
A word cloud of the top 75 words associated with fear (red) and top 75 words associated with trust (green). Are there more words associated with joy or with sadness in our titles?
